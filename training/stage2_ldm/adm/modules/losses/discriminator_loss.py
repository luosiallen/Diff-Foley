...
class GeneratorAdversarialLoss(torch.nn.Module):
    ...
    def __init__(
        ...
        assert loss_type in ["mse", "hinge", "hinge_baseline"], f"{loss_type} is not supported."
        if loss_type == "mse":
            self.criterion = self._mse_loss
        elif loss_type == "hinge":
            self.criterion = self._hinge_loss
        elif loss_type == "hinge_baseline":
            self.criterion = self._hinge_baseline_loss
    ...
    def _hinge_baseline_loss(self, x):
